...
@section('css')
<link href="{{ asset('css/dashboard/settings/style.css') }}" rel="stylesheet">
<link href="{{ asset('css/dashboard/settings/modal.css') }}" rel="stylesheet">
    ...
    <div class="row">
        ...
        <div class="col-sm-6">
            <ol class="breadcrumb pt-0 pr-0 float-left float-sm-right ">
                <li class="breadcrumb-item"><a href="{{ route('settings.index') }}" class="default-color"> Settings</a></li>
...
@endsection
@section('js')
<script src="{{ asset('js/dashboard/settings/settings.js') }}"></script>
@endsection