...
<body>
 ...
 preloader -->
        ...
        <div id="pre-loader">
            <img src="{{url('assets/images/pre-loader/loader-01.svg')}}" alt="">
        </div>
                            ...
                            <div class="tab nav-border" style="position: relative;">
                                ...
                                <div class="tab-content" id="myTabContent">
                                    <div class="tab-pane fade active show" id="months" role="tabpanel"
                                        ...
                                        <div class="row mb-30">
                                            <div class="col-md-2 col-sm-6">
                                                <img class="img-fluid" src="{{url('assets/images/blog/05.jpg')}}" alt="">
                                            </div>
                                        ...
                                        <div class="row mb-30">
                                            <div class="col-md-2 col-sm-6">
                                                <img class="img-fluid" src="{{url('assets/images/blog/02.jpg')}}" alt="">
                                            </div>
                                            <div class="col-md-6 col-sm-6">
                                        ...
                                        <div class="row mb-30">
                                            <div class="col-md-2 col-sm-6">
                                                <img class="img-fluid" src="{{url('assets/images/blog/03.jpg')}}" alt="">
                                            </div>
                                            <div class="col-md-6 col-sm-6">
                                        ...
                                        <div class="row">
                                            <div class="col-md-2 col-sm-6">
                                                <img class="img-fluid" src="{{url('assets/images/blog/04.jpg')}}" alt="">
                                            </div>
                                            <div class="col-md-6 col-sm-6">
                                    ...
                                    <div class="tab-pane fade" id="year" role="tabpanel" aria-labelledby="year-tab">
                                        <div class="row mb-30">
                                            <div class="col-md-2 col-sm-6">
                                                <img class="img-fluid" src="{{url('assets/images/blog/09.jpg')}}" alt="">
                                            </div>
                                            <div class="col-md-6 col-sm-6">
                                        ...
                                        <div class="row mb-30">
                                            <div class="col-md-2 col-sm-6">
                                                <img class="img-fluid" src="{{url('assets/images/blog/06.jpg')}}" alt="">
                                            </div>
                                            <div class="col-md-6 col-sm-6">
                                        ...
                                        <div class="row mb-30">
                                            <div class="col-md-2 col-sm-6">
                                                <img class="img-fluid" src="{{url('assets/images/blog/07.jpg')}}" alt="">
                                            </div>
                                            <div class="col-md-6 col-sm-6">
                                        ...
                                        <div class="row">
                                            <div class="col-md-2 col-sm-6">
                                                <img class="img-fluid" src="{{url('assets/images/blog/08.jpg')}}" alt="">
                                            </div>
                                            <div class="col-md-6 col-sm-6">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-unstyled">
                                <li class="mb-20">
                                    <div class="media">
                                        <div class="position-relative">
                                            <img class="img-fluid mr-15 avatar-small" src="{{url('assets/images/item/01.png')}}" alt="">
                                        </div>
                                ...
                                <li class="mb-20">
                                    <div class="media">
                                        <div class="position-relative clearfix">
                                            <img class="img-fluid mr-15 avatar-small" src="{{url('assets/images/item/02.png')}}" alt="">
                                        </div>
                                        <div class="media-body">
                                ...
                                <li class="mb-20">
                                    <div class="media">
                                        <div class="position-relative">
                                            <img class="img-fluid mr-15 avatar-small" src="{{url('assets/images/item/03.png')}}" alt="">
                                        </div>
                                        <div class="media-body">
                                ...
                                <li>
                                    <div class="media">
                                        <div class="position-relative clearfix">
                                            <img class="img-fluid mr-15 avatar-small" src="{{url('assets/images/item/04.png')}}" alt="">
                                        </div>
                                        <div class="media-body">
                    ...
                    <div class="card card-statistics h-100">
                        ...
                        <div class="card-body text-center position-relative">
                            <div class="avatar-top">
                                <img class="img-fluid w-25 rounded-circle " src="{{url('assets/images/team/13.jpg')}}" alt="">
                            </div>
                            <div class="row">
                            ...
                            <p class="mt-10">{{auth()->user()->email}} </p>
